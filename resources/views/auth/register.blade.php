<x-auth-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-auth.text-input id="name" class="block w-full mt-1" type="text" name="name" :value="old('name')"
        ...
        <div class="mt-4">
            ...
            <x-auth.text-input id="email" class="block w-full mt-1" type="email" name="email" :value="old('email')"
        ...
        <div class="mt-4">
            ...
            <x-auth.text-input id="password" class="block w-full mt-1" type="password" name="password" required
        ...
        <div class="mt-4">
            ...
            <x-auth.text-input id="password_confirmation" class="block w-full mt-1" type="password"
