<header x-data="{ openMenu: false }" class="bg-white">
    <nav class="flex items-center justify-between p-6 mx-auto max-w-7xl lg:px-8" aria-label="Global">
        ...
        <div x-data="{ open: false }" x-on:click.away="open = false" class="hidden lg:flex lg:gap-x-12">
            {{-- <div class="relative">
                <button x-on:click="open = !open" type="button"
                    class="flex items-center text-sm font-semibold leading-6 text-gray-900 gap-x-1"
                    aria-expanded="false">
                    Product
                    <svg class="flex-none w-5 h-5 text-gray-400" :class="{ 'rotate-180': open }" viewBox="0 0 20 20"
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            ...
            @else
                <div class="mr-3 text-sm font-semibold leading-6 text-gray-900 hover:underline">
    ...
    <div x-cloak x-show="openMenu" x-on:click.away="openMenu = false" class="lg:hidden" role="dialog"
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                ...
                <button x-on:click="openMenu = !openMenu" type="button" class="-m-2.5 rounded-md p-2.5 text-gray-700">
                    ...
                    <div class="py-6 space-y-2">
                        {{-- <div x-data="{ open: false }" class="-mx-3">
                            <button x-on:click="open = !open" type="button"
                                ...
                                Product
                                <svg class="flex-none w-5 h-5" :class="{ 'rotate-180': open }" viewBox="0 0 20 20"
                                    fill="currentColor" aria-hidden="true">
                                    <path fill-rule="evenodd"
                                        d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z"
                                        clip-rule="evenodd" />
                            ...
                            <div x-cloak x-show="open" class="mt-2 space-y-2" id="disclosure-1">
                                <a href="#"
                                    class="block py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 rounded-lg hover:bg-gray-50">Analytics</a>
                                <a href="#"
                                    class="block py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 rounded-lg hover:bg-gray-50">Engagement</a>
                                <a href="#"
                                    class="block py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 rounded-lg hover:bg-gray-50">Security</a>
                                <a href="#"
                                    class="block py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 rounded-lg hover:bg-gray-50">Integrations</a>
                                <a href="#"
                                    class="block py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 rounded-lg hover:bg-gray-50">Automations</a>
                                <a href="#"
                                    class="block py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 rounded-lg hover:bg-gray-50">Watch
                                    demo</a>
                                <a href="#"
                                    class="block py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 rounded-lg hover:bg-gray-50">Contact
                                    sales</a>
                            </div>
                        </div> --}}
                        <a href="#"
